...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  /*
   ...
   \-----------------------------------------------------'
  */
  [_BASE] = LAYOUT(KC_MSTP, KC_MNXT, KC_MPLY, KC_MPRV, LCAG(KC_4), LCAG(KC_3), LCAG(KC_2), LCAG(KC_1), LCAG(KC_8), LCAG(KC_7), LCAG(KC_6), LCAG(KC_5), KC_MUTE, LGUI(KC_L), LCAG(KC_0), LCAG(KC_9), TT(1)),
  /*
        SUB LAYER
   /-----------------------------------------------------`
